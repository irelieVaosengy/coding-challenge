...
const ListItem = ({data, isAwesomeNinja}) => {
    const className = `list-item ${isAwesomeNinja ? 'list-item_awesome-ninja' : ''}`
    return <div className={className}>
        ...
        <div className="list-item_details">
            ...
            <span className="list-item_h2">{data.dailyDownloadNumber }</span>
            <span className="list-item_h3">{data.popularityRange }</span>
        </div>
